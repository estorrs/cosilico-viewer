...
class ZarrVectorLoader {
    constructor(zarrUrl, fullImageHeight, fullImageWidth, pixelProjection, tileSize = 512, resolutions, featureGroup = 0) {
        ...
        return new VectorTileSource({
            ...
            tileLoadFunction: async (tile, url) => {
                if (tile instanceof VectorTile) {
                    ...
                    const groupPath = `/zooms/${resolution}/${x}_${y}/${this.featureGroup}`;
